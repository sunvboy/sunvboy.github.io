						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group hide">
									<label class="col-sm-2 control-label">Noi muốn du học</label>
									<div class="col-sm-4">
										<?php echo form_input('notes', set_value('notes', $detailContact['notes']), 'class="form-control" placeholder="Noi muốn du học"');?>
									</div>
									<label class="col-sm-1 control-label hide">Nơi nhận</label>
