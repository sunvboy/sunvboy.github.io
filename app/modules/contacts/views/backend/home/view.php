		...
		<div class="box-body table-responsive no-padding">
			<table class="table table-hover table-bordered table-striped">
				...
				<tr>
					...
					<td><?php echo $contact['title'];?> <?php echo $contact['fullname'];?> <br /><?php echo $contact['email'];?></td>
					<td><?php echo $contact['phone'];?></td>
					<td class=""><?php echo $contact['address'];?></td>
					...
					<td class="text-center">
						<div class="btn-group">
							...
							<a href="<?php echo site_url('contacts/backend/home/update/'.$contact['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-default hide"><i class="fa fa-edit"></i></a>
							<a href="<?php echo site_url('contacts/backend/home/read/'.$contact['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-default hide"><i class="fa fa-eye"></i></a>
						</div>
					 </td>
				</tr>
				<?php } ?>
