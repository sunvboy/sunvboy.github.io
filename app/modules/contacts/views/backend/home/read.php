			...
			<section class="invoice">
				...
				<div class="row invoice-info">
					...
					<div class="col-sm-4 invoice-col">
						...
						<br>
						<address>
						<strong><?php echo $detailContact['vande'];?> <?php echo $detailContact['fullname'];?></strong><br>
				...
				<div class="row no-print">
					<div class="col-xs-12">
						<a href="<?php echo site_url('contacts/backend/home/update/'.$detailContact['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-primary pull-right hide"><i class="fa fa-edit"></i> Cập nhật</a>
