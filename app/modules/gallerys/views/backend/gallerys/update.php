<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('gallerys/backend/gallerys/view'); ?>">Danh sách hình ảnh</a></li>
        <li class="active"><a href="<?php echo site_url('gallerys/backend/gallerys/create'); ?>">Thêm mới</a></li>
    </ol>
</section>
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#tab-album" data-toggle="tab">Album Ảnh</a></li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label tp-text-left">Tên</label>

                                    <div class="col-sm-10">
                                        <?php echo form_input('title', set_value('title', $DetailArticles['title']), 'class="form-control form-static-link" placeholder="Tên"'); ?>
                                    </div>
                        ...
                        <div class="tab-pane" id="tab-album">
                            <div class="box-body">
                                <div class="form-group" id="fromSlide">
                                    <?php $album = json_decode($DetailArticles['albums'], TRUE);
