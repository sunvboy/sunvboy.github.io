<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('gallerys/backend/gallerys/view');?>">Danh sách hình ảnh</a></li>
	</ol>
</section>
		...
		<div class="box-header">
			<h3 class="box-title pull-right">
				<div class="btn-group add-sort">
					...
					<a href="<?php echo site_url('gallerys/backend/gallerys/create');?>" class="btn btn-add  btn-flat"><i class="fa fa-plus"></i> Thêm mới</a>
				</div>
			</h3>
