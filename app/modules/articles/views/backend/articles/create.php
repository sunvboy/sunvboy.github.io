                                        ...
                                        <?php foreach ($album['images'] as $key => $val) {
                                            ...
                                            <div class="col-sm-3 slideItem">
                                                ...
                                                <textarea name="album[description][]" cols="40" rows="10"
                                                          ...
                                                          placeholder="Mô tả"><?php echo $album['description'][$key]; ?></textarea>
                        ...
                        <div class="tab-pane" id="tab-khoahoc">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo form_textarea('doituonghoc', htmlspecialchars_decode(set_value('doituonghoc')), 'id="txtContent12" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo form_textarea('trinhdo', htmlspecialchars_decode(set_value('trinhdo')), 'id="txtContent13" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo form_textarea('muctieuhoc', htmlspecialchars_decode(set_value('muctieuhoc')), 'id="txtContent14" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo form_textarea('daura', htmlspecialchars_decode(set_value('daura')), 'id="txtContent15" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
...
<script type="text/javascript">
    $(window).load(function () {
        ...
        item = item + '<input type="text" name="albumlist[title][]" value="" class="form-control title" placeholder="Tên"/>';
