<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo site_url('articles/backend/articles/create'); ?>">Thêm bài viết mới</a>
        </li>
    </ol>
</section>
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <!--						<li><a href="#tab-albums" data-toggle="tab">PHỤ HUYNH NÓI VỀ ALES</a></li>-->
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box-body">
                                <div class="form-group" id="fromSlidelist">
                                    ...
                                    if (isset($slidelist) && is_array($slidelist) && count($slidelist)) {
                                        foreach ($slidelist['title'] as $key => $val) {
                                            $albumlist[$key]['images'] = $val;
                                            $albumlist[$key]['title'] = $slidelist['title'][$key];
                                            $albumlist[$key]['description'] = $slidelist['description'][$key];
                                            $albumlist[$key]['content'] = $slidelist['content'][$key];
                                        }
                                    } else {
                                        $albumlist = json_decode($DetailArticles['album'], TRUE);
                                    }
                                    ?>
                                        ...
                                        <?php foreach ($albumlist as $key => $val) {
                                            ...
                                            <div class="col-sm-3 slideItem">
                                                ...
                                                <textarea name="albumlist[description][]" cols="40" rows="10"
                                                          ...
                                                          placeholder="Địa chỉ"><?php echo $albumlist[$key]['description']; ?></textarea>
                                                      <textarea name="albumlist[content][]" cols="40" rows="10"
                                                                class="form-control description"
                                                                placeholder="Nội dung"><?php echo $albumlist[$key]['content']; ?></textarea>
                                                <button type="button"
                        ...
                        <!-- /.tab-pane -->
                        <div class="tab-pane" id="tab-khoahoc">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label tp-text-left">Đối tượng học</label>

                                    <div class="col-sm-10">
                                        <?php echo form_textarea('doituonghoc', htmlspecialchars_decode(set_value('doituonghoc', $DetailArticles['doituonghoc'])), 'id="txtContent12" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label tp-text-left">Trình độ</label>

                                    <div class="col-sm-10">
                                        <?php echo form_textarea('trinhdo', htmlspecialchars_decode(set_value('trinhdo', $DetailArticles['trinhdo'])), 'id="txtContent13" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label tp-text-left">Mục tiêu học</label>

                                    <div class="col-sm-10">
                                        <?php echo form_textarea('muctieuhoc', htmlspecialchars_decode(set_value('muctieuhoc', $DetailArticles['muctieuhoc'])), 'id="txtContent14" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label tp-text-left">Đầu ra</label>

                                    <div class="col-sm-10">
                                        <?php echo form_textarea('daura', htmlspecialchars_decode(set_value('daura', $DetailArticles['daura'])), 'id="txtContent15" class="ckeditor-description" placeholder="Nội dung" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
                                ...
                                <div class="form-group" id="fromSlide">
                                    ...
                                    <?php if (isset($album) && is_array($album) && count($album)) { ?>
                                        <?php foreach ($album as $key => $val) { ?>
                                            <div class="col-sm-3 slideItem">
                                                <div class="thumb"><img
                                                        src="<?php echo (!empty($album[$key]['images'])) ? $album[$key]['images'] : 'templates/not-found.png'; ?>"
                                                        class="img-thumbnail1 img-responsive"/></div>
                                                <input type="hidden" name="album[images][]"
                                                       value="<?php echo $album[$key]['images']; ?>"/>

                                                <div class="thumb hide"><img
                                                        src="<?php echo (!empty($album[$key]['content'])) ? $album[$key]['content'] : 'templates/not-found.png'; ?>"
                                                        class="img-thumbnail1 img-responsive"/></div>
                                                <input type="hidden" name="album[content][]"
                                                       value="<?php echo $album[$key]['content']; ?>"/>
                                                ...
                                                <textarea name="album[description][]" cols="40" rows="10"
                                                          class="form-control description"
                                                          placeholder="Mô tả"><?php echo $album[$key]['description']; ?></textarea>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-seo">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img
                                            src="<?php echo (!empty($DetailArticles['images'])) ? $DetailArticles['images'] : 'templates/not-found.png'; ?>"
                                            class="img-thumbnail" alt="" style="width: 100%;border-radius: 0;"/></div>
                            ...
                            <?php } ?>
                            <div class="form-group hide">
                                <label class="col-sm-12 control-label tp-text-left">Giá dịch vụ( Bảng giá) nghìn
                                    VNĐ</label>
                            </div>
                            <div class="form-group hide">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group hide">
                                <label class="col-sm-12 control-label tp-text-left">Giới thiệu</label>
                            </div>
                            <div class="form-group hide">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group hide">
                                <label class="col-sm-12 control-label tp-text-left">Đặc biệt</label>
                            </div>
                            <div class="form-group hide">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group hide">
                                <label class="col-sm-12 control-label tp-text-left">Giới thiệu 3</label>
                            </div>
                            <div class="form-group hide">
                                <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).on('click', '.img-thumbnail1', function () {
        openKCFinderAlbum($(this));
    });
</script>
<script type="text/javascript">
    $(window).load(function () {
        ...
        item = item + '<input type="hidden" name="album[content][]" value="" />';
        item = item + '<input type="text" name="album[title][]" value="" class="form-control title" placeholder="Tên"/>';
        item = item + '<textarea name="album[description][]" cols="40" rows="10" class="form-control description" placeholder="Mô tả"></textarea>';
...
<script type="text/javascript">
    $(window).load(function () {
        ...
        item = item + '<textarea name="albumlist[description][]" cols="40" rows="10" class="form-control description" placeholder="Địa chỉ"></textarea>';
        item = item + '<textarea name="albumlist[content][]" cols="40" rows="10" class="form-control content" placeholder="Mô tả"></textarea>';
