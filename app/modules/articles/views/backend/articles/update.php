						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab-album">
								<div class="box-body">
									...
									<div class="col-sm-3 slideItem">
                                        <div class="thumb"><img src="<?php echo (!empty($album[$key]['images']))? $album[$key]['images']:'templates/not-found.png'; ?>" class="img-thumbnail1 img-responsive"/></div>
									<input type="hidden" name="album[images][]" value="<?php echo $album[$key]['images'];?>" />

										<div class="thumb"><img src="<?php echo (!empty($album[$key]['content']))? $album[$key]['content']:'templates/not-found.png'; ?>" class="img-thumbnail1 img-responsive"/></div>
										<input type="hidden" name="album[content][]" value="<?php echo $album[$key]['content'];?>" />

									<input type="text" name="album[title][]" value="<?php echo $album[$key]['title'];?>" class="form-control title" placeholder="Tên" />
									<textarea name="album[description][]" cols="40" rows="10" class="form-control description" placeholder="Mô tả"><?php echo $album[$key]['description'];?></textarea>
