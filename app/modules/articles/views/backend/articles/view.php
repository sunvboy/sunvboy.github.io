                ...
                <div class="box-header">
                    <h3 class="box-title pull-right">
                        <div class="btn-group add-sort">
                            ...
                            <a href="<?php echo site_url('articles/backend/articles/create'); ?>"
                               class="btn btn-add  btn-flat"><i class="fa fa-plus"></i> Thêm bài viết</a>
                        </div>
                    </h3>
                    <div class="box-tools pull-left">
                        <span class="gcheckAction pull-left btn btn-default" data-module="articles"><i
                                class="fa fa-trash"></i></span>

                        <form class="pull-left" method="get"
                              action="<?php echo site_url('articles/backend/articles/view'); ?>">
                            ...
                            <table class="table" id="diagnosis-list">
                                ...
                                <?php foreach ($ListArticles as $key => $item) { ?>
                                    ...
                                    <tr>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="meta">
                                                        <span class="user-create"><i class="fa fa-user"></i> <a
                                                                href="<?php echo site_url('articles/backend/articles/view?userid=' . $item['userid_created'] . '') ?>"
                                                    ...
                                                    <div class="catalogue">
                                                        <?php if (!empty($item['fullname_update'])) { ?>
                                                            <span class="user-create"><i class="fa fa-user"></i> <a
                                                                    href="<?php echo site_url('articles/backend/articles/view?userid=' . $item['userid_updated'] . '') ?>"
                                                                    title=""><?php echo $item['fullname_update']; ?></a></span>
                                                        <?php } ?>
                                                        <?php foreach ($_catalogue_list as $keyCat => $valCat) { ?>
                                                            <span><i class="fa fa-folder-open"></i> <a
                                                                    href="<?php echo site_url('articles/backend/articles/view?cataloguesid=' . $valCat['id'] . ''); ?>"
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                <a href="<?php echo site_url('articles/backend/articles/delete/' . $item['id']) . '?redirect=' . urlencode(current_url()); ?>"
                                                   class="btn btn-default"><span class="fa fa-trash"></span></a>
                                                <a href="<?php echo site_url('articles/backend/articles/update/' . $item['id']) . '?redirect=' . urlencode(current_url()); ?>"
                                                   class="btn btn-default"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo site_url('articles/backend/articles/read/' . $item['id']) . '?redirect=' . urlencode(current_url()); ?>"
