                        ...
                        <div class="tab-pane active" id="tab-info">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2"><span class="btn btn-primary create-static-links"
                                                                data-module="articles" data-catalogue="catalogues">Tạo liên kết tĩnh</span>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-seo">
                            ...
                            <div class="form-group hide">
                                <div class="col-sm-12">
                                    <?php echo form_input('video', set_value('video'), 'class="form-control"  placeholder="Video upload" onclick="openKCFinder(this, \'file\')" '); ?>
                                </div>
                            </div>
