						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<?php echo form_input('skype', set_value('skype', $DetailCustomers['skype']), 'class="form-control" placeholder="Năm sinh"');?>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_dropdown('sex', $this->configbie->data('sex'), set_value('sex', $DetailCustomers['sex']), 'class="form-control" style="width: 100%;"');?>
									</div>
