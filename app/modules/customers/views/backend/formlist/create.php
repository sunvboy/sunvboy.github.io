					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<?php echo form_input('room', set_value('room'), 'class="form-control" placeholder="Tên phòng khám"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Kết luận</label>
									<div class="col-sm-10">
										<?php echo form_input('result_note', set_value('result_note'), 'class="form-control" placeholder="Kết luận"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Ghi chú</label>
									<div class="col-sm-10">
										<?php echo form_textarea('note', htmlspecialchars_decode(set_value('note')), 'id="txtDescription" class="ckeditor-description" placeholder="Ghi chú"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Ghi chú thêm</label>
									<div class="col-sm-10">
										<?php echo form_input('note_note', set_value('note_note'), 'class="form-control" placeholder="Ghi chú thêm"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Loại xét nghiệm</label>
									<div class="col-sm-10">
										<?php echo form_input('type', set_value('type'), 'class="form-control" placeholder="Loại xét nghiệm"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
						<div class="tab-pane" id="tab-files">
							<div class="box-body">
								...
								<?php $result = $this->input->post('result'); ?>
								<?php if(isset($result) && is_array($result) && count($result)){ ?>
									<?php foreach($result['file'] as $key => $val){ ?>
										<?php if(empty($result['file'][$key])) continue; ?>
											<div class="col-sm-3 slideItem" style="height: 152px;">
												<div class="thumb">
													<img src="<?php echo $result['file'][$key];?>" class="img-thumbnail img-responsive"/>
												</div>
												<input type="hidden" name="result[file][]" value="<?php echo $result['file'][$key];?>" />
					...
					<ul class="nav nav-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-seo">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo form_input('date', set_value('date', gmdate('d-m-Y', time() + 7*3600)), 'class="form-control datetimepicker"');?>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo form_dropdown('doctorid', $this->BackendCustomers_Model->Dropdown(2), set_value('doctorid'), 'class="form-control"');?>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12" id="customers">
										<?php echo form_dropdown('customersid', $this->BackendCustomers_Model->Dropdown(1), set_value('customersid'), 'class="form-control"');?>
									</div>
								</div>
								<div class="form-group">
