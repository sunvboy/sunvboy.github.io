					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-advanced">
							<div class="box-body">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Ảnh đại diện menu con</label>
									<div class="col-sm-10">
										<div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img
												src="<?php echo (isset($avatar) && !empty($avatar)) ? $avatar : 'templates/not-found.png'; ?>"
												class="img-thumbnail" alt=""
										...
										<?php echo form_input('images_sub', set_value('images_sub'), 'class="form-control"  placeholder="Ảnh đại diện menu con"  '); ?>
