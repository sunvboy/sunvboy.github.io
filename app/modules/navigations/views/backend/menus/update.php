					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-advanced">
							<div class="box-body">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Ảnh đại diện</label>
									<div class="col-sm-10">
										<div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img
												src="<?php echo (!empty($DetailNavigationsMenus['images'])) ? $DetailNavigationsMenus['images'] : 'templates/not-found.png'; ?>"
												class="img-thumbnail" alt=""
												style="width: 100%;border-radius: 0;object-fit: scale-down;height: 200px;"/>
										</div>
										<?php echo form_input('images', set_value('images', $DetailNavigationsMenus['images']), 'class="form-control"  placeholder="Ảnh đại diện" onclick="openKCFinder(this)" '); ?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Ảnh đại diện menu con</label>
									<div class="col-sm-10">
										<div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img
												src="<?php echo (!empty($DetailNavigationsMenus['images_sub'])) ? $DetailNavigationsMenus['images_sub'] : 'templates/not-found.png'; ?>"
												class="img-thumbnail" alt=""
												style="width: 100%;border-radius: 0;object-fit: scale-down;height: 200px;"/>
										</div>
										<?php echo form_input('images_sub', set_value('images_sub', $DetailNavigationsMenus['images_sub']), 'class="form-control"  placeholder="Ảnh đại diện" onclick="openKCFinder(this)" '); ?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
