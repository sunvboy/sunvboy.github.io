<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo site_url('supports/backend/supports/create'); ?>">Thêm hỗ trợ trực tuyến
                mới</a></li>
    </ol>
</section>
                        ...
                        <div class="tab-pane active" id="tab-info">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label hide">Nhóm</label>
                                    ...
                                    <div class="col-sm-4">
                                        <?php echo form_input('yahoo', set_value('yahoo'), 'class="form-control" placeholder="Chức vụ"'); ?>
                                    </div>
                                ...
                                <div class="form-group hide">
                                    ...
                                    <label class="col-sm-2 control-label hide">Pinterest</label>
