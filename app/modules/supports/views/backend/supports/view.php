...
<!--					<th>Phone</th>-->
				...
				<tr>
					...
					<td><img src="<?php echo $contact['images'];?>" style="width: 100px;"></td>
					<td><?php echo $contact['fullname'];?> <br /><?php echo $contact['phone'];?></td>
					<td class="hide">
					...
					<td class="hide"><?php echo $contact['phone'];?></td>
