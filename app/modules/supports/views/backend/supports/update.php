						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<label class="col-sm-2 hide control-label">Nhóm</label>
									...
									<div class="col-sm-4">
										<?php echo form_input('yahoo', set_value('yahoo', $DetailSupports['yahoo']), 'class="form-control" placeholder="Chức vụ"');?>
									</div>
