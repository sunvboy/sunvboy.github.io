...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('items/backend/items/view');?>">Danh mục đơn hàng</a></li>
	</ol>
</section>
		...
		<div class="col-xs-9">
			<div class="box">
				...
				<?php if(isset($payment) && is_array($payment) && count($payment)){ ?>
					...
					//echo "<pre>"; var_dump($_payment_list_);die;
					?>
							...
							<table class="table table-hover" id="diagnosis-list">
								...
								<?php foreach($_payment_list_ as $key => $item){ ?>
									<tr>
										...
										<td style="text-align:center;"><a href="<?php echo $href; ?>" target="_blank" title="" style="color:#333;font-size:12px;font-weight:bold;"><?php echo $item['detail']['title']; ?></a></td>
										<td style="text-align:center;" class="hide"><p style="width: 20px;height: 20px;background-color:<?php echo $item['color']; ?>;text-align: center "></p></td>
								...
								<tr>
									...
									<td style="width:40px;"><span class="<?php echo ($payment['status'] == 'success') ? 'done' : 'not-done'; ?>" style="font-size:15px;font-weight:bold;"><?php echo str_replace(',','.',number_format($payment['total_price'])); ?>$</span></td>
								</tr>
							</table>
						</form>
					</div><!-- /.box-body -->
		...
		<div class="col-xs-3">
			<div class="box">
				...
				<div class="box-body">
					...
					<p><i class="fa fa-credit-card" aria-hidden="true"></i> <span style="font-weight:bold;margin-left:10px;">Số khách(người lớn): <?php echo $payment['person']; ?></span></p>
					<p><i class="fa fa-credit-card" aria-hidden="true"></i> <span style="font-weight:bold;margin-left:10px;">Số khách(trẻ em): <?php echo $payment['child']; ?></span></p>
					...
					<p class="hide"><i class="fa fa-map-marker" aria-hidden="true"></i> <span style="font-weight:bold;margin-left:10px;"><?php echo $payment['address']; ?></span></p>
