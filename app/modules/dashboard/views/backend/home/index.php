        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="<?php echo site_url('payments/backend/payments/view') . '?status=wait'; ?>" target="_blank"
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="<?php echo site_url('products/backend/products/view'); ?>" target="_blank"
                       class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="#" onclick="return false;" class="small-box-footer">More info <i
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="<?php echo site_url('contacts/backend/home/view'); ?>" target="_blank"
                       class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
                    ...
                    <?php foreach ($_payments as $key => $val) { ?>
                      ...
                      <span class="handle ui-sortable-handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                            ...
                            <!-- todo text -->
                            <span class="text"><a style="color:#333;"
                                                  href="<?php echo site_url('payments/backend/items/view/' . $val['id'] . ''); ?>"
                                                  title=""><?php echo $val['fullname']; ?></a> - Đơn giá : <span
                                    style="color:#dd4b39;text-align:right;"><?php echo str_replace(',', '.', number_format($val['total_price'])); ?>
                                    đ</span></span>
                            <!-- Emphasis label -->
                            <small class="label label-danger"><i class="fa fa-clock-o"></i>
                                <time class="timeago" datetime="<?php echo $val['created']; ?>"></time>
                            </small>
        ...
        <script>
            $(window).load(function () {
                ...
                var param_condition_product_per_year = {
                    "caption": "Thống kê kết quả kinh doanh năm <?php echo $year; ?>",
                    "subCaption": "<?php echo $this->fcSystem['contact_web']; ?>",
                    "xAxisName": "Tháng",
                    "yAxisName": "Loại tiền (In VNĐ)",
                    "numberPrefix": "",
                    "numberSuffix": " VNĐ",
                ...
                var param_condition_product_most_viewed = {
                    "caption": "Top 05 sản phẩm xem nhiều nhất",
                    "subCaption": "<?php echo $this->fcSystem['contact_web']; ?>",
                    "xAxisName": "",
                    "yAxisName": "Số lượt xem",
                    "numberPrefix": "",
                    "numberSuffix": " ",
                    "paletteColors": "#0075c2",
                    "bgColor": "#caf7c0",
                ...
                (function () {
                    $("#chart-container").insertFusionCharts({
                        ...
                        dataFormat: "json",
                        dataSource: {
                            "chart": param_condition_product_per_year,
                            "data": <?php echo json_encode($result); ?>
                        }
                    });
                    $("#chart-top-product-container").insertFusionCharts({
                        type: "bar2d",
                        width: width_2 - 4,
                        height: "300",
                        dataFormat: "json",
                        dataSource: {
                            "chart": param_condition_product_most_viewed,
                            "data": <?php echo json_encode($top_p); ?>
                        }
                    });
                }());
            });
