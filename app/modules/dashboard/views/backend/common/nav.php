...
<nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <?php */ ?>
            <li class="hide language-header <?php echo(($auth['lang'] == 'english') ? 'active-lang' : '') ?>"
                data-lang="english">
                <img src="templates/backend/images/english.png" class="img-lang" alt="english">
            </li>

            <li class="hide language-header <?php echo(($auth['lang'] == 'china') ? 'active-lang' : '') ?>"
                data-lang="china">
                <img src="templates/backend/images/china.png" class="img-lang" alt="china"
            ...
            <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span
                        class="hidden-xs"><?php echo !empty($fcUser['fullname']) ? $fcUser['fullname'] : $fcUser['email']; ?></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="user-header">
                        ...
                        <p>
                            ...
                            <small><?php echo $fcUser['groups_title']; ?> (<?php echo gettime($fcUser['created']); ?>)
                            </small>
                        </p>
                    </li>
                    <li class="user-footer">
                        <div class="pull-left">
                            <a href="<?php echo site_url('users/backend/account/information'); ?>"
                               class="btn btn-default btn-flat">Hồ sơ</a>
                        </div>
                        <div class="pull-right">
                            <a href="<?php echo site_url('users/backend/auth/logout'); ?>"
