<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo site_url('places/backend/places/view');?>">Hệ thống nhà thuốc</a></li>
		<li class="active"><a href="<?php echo site_url('places/backend/places/update/'.$DetailPlaces['id']);?>">Cập nhật</a></li>
	</ol>
</section>
						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('title', set_value('title', $DetailPlaces['title']), 'class="form-control" placeholder="Tên hiệu thuốc"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Địa chỉ</label>
									<div class="col-sm-4">
										<?php echo form_input('address', set_value('address', $DetailPlaces['address']), 'class="form-control" placeholder="Địa chỉ"');?>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label tp-text-left">Số điện thoại</label>
									<div class="col-sm-4">
										<?php echo form_input('phone', set_value('phone', $DetailPlaces['phone']), 'class="form-control" placeholder="Số điện thoại"');?>
									</div>
								</div>
								<div class="form-group">
