<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="<?php echo site_url('places/backend/places/view');?>">Hệ thống nhà thuốc</a></li>
	</ol>
</section>
		...
		<div class="box-body table-responsive no-padding">
			<table class="table table-hover table-bordered table-striped">
				...
				<tr>
					...
					<td><?php echo $this->BackendProjects_Model->read_location($contact['wardid']);?> - <?php echo $this->BackendProjects_Model->read_location($contact['districtid']);?> - <?php echo $this->BackendProjects_Model->read_location($contact['cityid']);?></td>
