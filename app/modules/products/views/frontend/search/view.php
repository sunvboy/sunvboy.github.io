                    ...
                    <div class="main-content-c">
                        <ul class="ulink">
                            <li class="c">
                                ...
                                <li><a href="javascript:void()" title="<?php echo $this->lang->line('ket-qua-tim-kiem'); ?>
                                : <?php echo((isset($keys)) ? $keys : '') ?>"><?php echo $this->lang->line('ket-qua-tim-kiem'); ?>
                                        : <?php echo((isset($keys)) ? $keys : '') ?></a>
                                </li>
                        ...
                        <section class="item-category">
                            <h1 class="hidden"><?php echo $this->lang->line('ket-qua-tim-kiem'); ?>
                                : <?php echo((isset($keys)) ? $keys : '') ?></h1>
