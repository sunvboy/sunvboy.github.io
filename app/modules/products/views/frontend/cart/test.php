                ...
                <div class="uk-grid uk-grid-medium information">
                    <div class="uk-width-medium-6-10">
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" uk-clearfix mb15">
                                    ...
                                    <div class="col right"><input type="text" name="fullname" class="text uk-width-1-1"
                                                                  placeholder="Ví d?: Nguy?n V?n A"/></div>
                                </div>
                                <div class=" uk-clearfix mb15">
                                    <div class="col left"><label for=""
                                    ...
                                    <div class="col right"><input type="text" name="phone" class="text uk-width-1-1"
                                                                  placeholder="Ví d?: 0987654321"/></div>
                                </div>
                                <div class=" uk-clearfix mb15">
                                ...
                                <div class=" provincial uk-clearfix mb15">
                                    ...
                                    <div class="col right">
                                        <?php echo form_dropdown('cityid', location_dropdown('Thành ph?', array('parentid' => 0)), set_value('cityid'), 'class="form-control"  style="width: 100%;" id="cityid"'); ?>
                                    </div>
                                </div>
                                <div class=" provincial uk-clearfix mb15">
                                    <div class="col left"><label for=""
                                ...
                                <div class=" uk-clearfix mb15">
                                    ...
                                    <div class="col right"><input type="text" name="address" class="text uk-width-1-1"
                                                                  placeholder="Ví d?: S? 10, Ngõ 50, ???ng ABC"/></div>
                                </div>
                                <div class=" uk-clearfix mb15">
                                    <div class="col left"><label for=""
                        ...
                        <!-- <div class="uk-panel giftcode mb20">
                            <div class="panel-head"><h3 class="title"><span class="text">S? d?ng mã gi?m giá</span></h3></div>
                            <div class="panel-body">
                                <div class=" uk-position-relative mb15">
                                    <input type="text" name="discount_code" value="" class="text uk-width-1-1" placeholder="Nh?p mã gi?m giá" />
                                    <input type="submit" name="" class="btn" value="Áp d?ng" />
                                </div>
                                <div class="note">Sau khi áp d?ng, Mã gi?m giá có th? không dùng ???c trong vòng <span class="text-black">15 phút</span> <a class="link" href="" title="" >Xem chi ti?t</a>.</div>
                            </div>
                        </div> --><!-- .giftcode -->
                                                ...
                                                <div class="colinfo uk-float-right">
                                                    <div class=" uk-flex uk-flex-space-between mb10">
                                                        <div class="title ec-line-3"><a
                                                            ...
                                                            <span><p style="float: left">Màu s?c:</p> <p style="background: <?php echo $val['color'];?>;width: 20px;height: 20px;float:left;"></p></span>
