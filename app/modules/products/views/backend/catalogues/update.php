...
<!--						<li class=""><a href="#tab-albums" data-toggle="tab">Albums ảnh</a></li>-->
					</ul>
						...
						<div class="tab-pane active" id="tab-seo">
							<div class="box-body">
								...
								<div class="form-group hide">
									<label class="col-sm-12 control-label tp-text-left">Title</label>
								</div>
								<div class="form-group hide">
									<div class="col-sm-12">
										<?php echo form_input('imgback', set_value('imgback', (isset($DetailProductsCatalogues['imgback']) && !empty($DetailProductsCatalogues['imgback']))?$DetailProductsCatalogues['imgback']: ''), 'class="form-control"  placeholder="Title" ');?>
									</div>
								</div>
								<div class="form-group hide">
									<div class="col-sm-12">
										<div class="avatar" style="margin-bottom: 10px;cursor: pointer;"><img src="<?php echo (isset($DetailProductsCatalogues['icon']) && !empty($DetailProductsCatalogues['icon']))?$DetailProductsCatalogues['icon']: 'templates/not-found.png'; ?>" class="img-thumbnail" alt="" style="width: 100%;border-radius: 0;" /></div>
										<?php echo form_input('icon', set_value('icon', (isset($DetailProductsCatalogues['icon']) && !empty($DetailProductsCatalogues['icon']))?$DetailProductsCatalogues['icon']: ''), 'class="form-control"  placeholder="Icon trên ảnh" onclick="openKCFinder(this)" ');?>
									</div>
								</div>
								<div class="form-group">
